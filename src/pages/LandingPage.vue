...
.hero-card {
  background: linear-gradient(135deg, #ff7e5f 0%, #feb47b 40%, #0d9488 100%);
  border-radius: 20px;
  padding: 70px 30px;
  text-align: center;
  color: #ffffff;
  box-shadow: 0 10px 30px rgba(255, 126, 95, 0.25);
}
...
<template>
  <div class="landing-wrapper">
    <!-- Navigation Bar -->
    <header class="navbar">
      <div class="brand-logo">SMK Yadika Soreang — Onlineshop</div>
      <nav class="nav-links">
    ...
    <section class="features-grid">
      <div class="feature-card">
        ...
        <p class="feature-desc">Pesanan langsung diproses te loba lila.</p>
      </div>

      <div class="feature-card">
        <span class="feature-icon">🏷️</span>
        <h3 class="feature-title">Diskon Siswa</h3>
        <p class="feature-desc">Harga mirah disesuaikan untuk pelajar.</p>
      </div>

      <div class="feature-card">
        <span class="feature-icon">🚚</span>
        <h3 class="feature-title">Bebas Ongkir</h3>
        <p class="feature-desc">cokot pesanan secara gratis tanpa biaya pengiriman tambahan.</p>
      </div>
    </section>
